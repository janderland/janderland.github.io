...
var author$project$Pages$Cover = {$: 'Cover'};
...
var author$project$Contents$contentList = _List_Nil;
...
var author$project$Contents$contentDict = elm$core$Dict$fromList(
	A2(
		elm$core$List$map,
		function (c) {
			return _Utils_Tuple2(c.id, c);
		},
		author$project$Contents$contentList));
var author$project$Pages$Chapter = function (a) {
	return {$: 'Chapter', a: a};
};
...
var author$project$Pages$chapter = function (id) {
	return A2(
		elm$core$Maybe$map,
		author$project$Pages$Chapter,
		A2(elm$core$Dict$get, id, author$project$Contents$contentDict));
};
...
var author$project$Pages$fromRoute = A2(
	elm$core$Basics$composeR,
	elm$core$Maybe$map(
		function (route) {
			if (route.$ === 'Cover') {
				return author$project$Pages$Cover;
			} else {
				var id = route.a;
				return A2(
					elm$core$Maybe$withDefault,
					author$project$Pages$NotFound,
					author$project$Pages$chapter(id));
			}
		}),
	elm$core$Maybe$withDefault(author$project$Pages$NotFound));
var author$project$Route$Chapter = function (a) {
	return {$: 'Chapter', a: a};
};
var author$project$Route$Cover = {$: 'Cover'};
...
var author$project$Route$parser = elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			A2(elm$url$Url$Parser$map, author$project$Route$Cover, elm$url$Url$Parser$top),
			A2(
			elm$url$Url$Parser$map,
			author$project$Route$Chapter,
			A2(
				elm$url$Url$Parser$slash,
				elm$url$Url$Parser$s('chapter'),
...
var author$project$Janderland$urlToPage = A2(elm$core$Basics$composeR, author$project$Route$fromUrl, author$project$Pages$fromRoute);
var author$project$State$Model = F4(
	function (key, page, width, layout) {
		return {key: key, layout: layout, page: page, width: width};
	});
var elm$core$Basics$fdiv = _Basics_fdiv;
var author$project$Views$base = 5 / 4;
var author$project$Views$coefficient = 16;
var elm$core$Basics$mul = _Basics_mul;
var elm$core$Basics$pow = _Basics_pow;
var elm$core$Basics$round = _Basics_round;
var elm$core$Basics$sub = _Basics_sub;
var elm$core$Basics$toFloat = _Basics_toFloat;
var author$project$Views$scaled = function (x) {
	var scale = x;
	return elm$core$Basics$round(
		author$project$Views$coefficient * A2(elm$core$Basics$pow, author$project$Views$base, scale - 1));
};
var author$project$Views$maxContentWidth = author$project$Views$scaled(17);
var elm$core$Basics$min = F2(
	function (x, y) {
		return (_Utils_cmp(x, y) < 0) ? x : y;
	});
var author$project$Views$clampWidth = function (viewportWidth) {
	return A2(elm$core$Basics$min, author$project$Views$maxContentWidth, viewportWidth);
};
var author$project$State$Full = {$: 'Full'};
var author$project$State$Mini = {$: 'Mini'};
var author$project$Views$layoutBoundary = author$project$Views$scaled(18);
var author$project$Views$layoutFromWidth = function (viewportWidth) {
	return (_Utils_cmp(viewportWidth, author$project$Views$layoutBoundary) > 0) ? author$project$State$Full : author$project$State$Mini;
};
...
var author$project$Janderland$init = F3(
	function (flags, url, key) {
		var width = author$project$Views$clampWidth(flags.width);
		var page = author$project$Janderland$urlToPage(url);
		var layout = author$project$Views$layoutFromWidth(flags.width);
		return _Utils_Tuple2(
			A4(author$project$State$Model, key, page, width, layout),
			elm$core$Platform$Cmd$none);
	});
var author$project$State$WindowResize = F2(
	function (a, b) {
...
var author$project$Janderland$subs = function (_n0) {
	return elm$browser$Browser$Events$onResize(author$project$State$WindowResize);
};
...
var author$project$Janderland$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'LinkClicked':
				var request = msg.a;
			...
			case 'UrlChanged':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							page: author$project$Janderland$urlToPage(url)
						}),
					elm$core$Platform$Cmd$none);
			default:
				var viewportWidth = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							layout: author$project$Views$layoutFromWidth(viewportWidth),
							width: author$project$Views$clampWidth(viewportWidth)
						}),
					elm$core$Platform$Cmd$none);
		}
	});
var author$project$State$LinkClicked = function (a) {
	return {$: 'LinkClicked', a: a};
};
var author$project$State$UrlChanged = function (a) {
...
var author$project$Views$base00 = A3(mdgriffith$elm_ui$Element$rgb255, 45, 45, 45);
var author$project$Views$backColor = author$project$Views$base00;
var author$project$Ogham$G = {$: 'G'};
var author$project$Ogham$S = {$: 'S'};
var author$project$Ogham$Space = {$: 'Space'};
var author$project$Ogham$T = {$: 'T'};
var author$project$Ogham$U = {$: 'U'};
var author$project$Ogham$UI = {$: 'UI'};
var author$project$Ogham$Z = {$: 'Z'};
var author$project$Ogham$default = function (_char) {
	switch (_char.valueOf()) {
		case 'j':
			return author$project$Ogham$G;
		case 'k':
			return author$project$Ogham$T;
		case 'v':
			return author$project$Ogham$Z;
		case 'w':
			return author$project$Ogham$U;
		case 'x':
			return author$project$Ogham$S;
		case 'y':
			return author$project$Ogham$UI;
		default:
			return author$project$Ogham$Space;
	}
};
var author$project$Ogham$AE = {$: 'AE'};
var author$project$Ogham$EA = {$: 'EA'};
var author$project$Ogham$IA = {$: 'IA'};
var author$project$Ogham$NG = {$: 'NG'};
var author$project$Ogham$OI = {$: 'OI'};
var author$project$Ogham$A = {$: 'A'};
var author$project$Ogham$B = {$: 'B'};
var author$project$Ogham$C = {$: 'C'};
var author$project$Ogham$D = {$: 'D'};
var author$project$Ogham$E = {$: 'E'};
var author$project$Ogham$F = {$: 'F'};
var author$project$Ogham$H = {$: 'H'};
var author$project$Ogham$I = {$: 'I'};
var author$project$Ogham$L = {$: 'L'};
var author$project$Ogham$M = {$: 'M'};
var author$project$Ogham$N = {$: 'N'};
var author$project$Ogham$O = {$: 'O'};
var author$project$Ogham$P = {$: 'P'};
var author$project$Ogham$Q = {$: 'Q'};
var author$project$Ogham$R = {$: 'R'};
var author$project$Ogham$singleParse = F2(
	function (mapper, _char) {
		switch (_char.valueOf()) {
			case 'a':
				return author$project$Ogham$A;
			case 'b':
				return author$project$Ogham$B;
			case 'c':
				return author$project$Ogham$C;
			case 'd':
				return author$project$Ogham$D;
			case 'e':
				return author$project$Ogham$E;
			case 'f':
				return author$project$Ogham$F;
			case 'g':
				return author$project$Ogham$G;
			case 'h':
				return author$project$Ogham$H;
			case 'i':
				return author$project$Ogham$I;
			case 'l':
				return author$project$Ogham$L;
			case 'm':
				return author$project$Ogham$M;
			case 'n':
				return author$project$Ogham$N;
			case 'o':
				return author$project$Ogham$O;
			case 'p':
				return author$project$Ogham$P;
			case 'q':
				return author$project$Ogham$Q;
			case 'r':
				return author$project$Ogham$R;
			case 's':
				return author$project$Ogham$S;
			case 't':
				return author$project$Ogham$T;
...
var author$project$Ogham$parseChars = F2(
	function (mapper, list) {
		var sParse = author$project$Ogham$singleParse(mapper);
		var recurse = author$project$Ogham$parseChars(mapper);
		if (!list.b) {
			return _List_Nil;
		} else {
			var head1 = list.a;
			...
			if (!dropped1.b) {
				...
				var head2 = dropped1.a;
				var dropped2 = dropped1.b;
				var _n2 = _Utils_Tuple2(head1, head2);
				_n2$6:
				while (true) {
					switch (_n2.b.valueOf()) {
						case 'e':
							if ('a' === _n2.a.valueOf()) {
								return A2(
									elm$core$List$cons,
									author$project$Ogham$AE,
									recurse(dropped2));
							} else {
								break _n2$6;
							}
						case 'a':
							switch (_n2.a.valueOf()) {
								case 'e':
									return A2(
										elm$core$List$cons,
										author$project$Ogham$EA,
										recurse(dropped2));
								case 'i':
									return A2(
										elm$core$List$cons,
										author$project$Ogham$IA,
										recurse(dropped2));
								default:
									break _n2$6;
							}
						...
						case 'i':
							switch (_n2.a.valueOf()) {
								case 'o':
									return A2(
										elm$core$List$cons,
										author$project$Ogham$OI,
										recurse(dropped2));
								case 'u':
									return A2(
										elm$core$List$cons,
										author$project$Ogham$UI,
										recurse(dropped2));
								default:
									break _n2$6;
							}
...
var author$project$Ogham$toChar = function (oghamChar) {
	switch (oghamChar.$) {
		case 'Space':
			return _Utils_chr('\u1680');
		case 'A':
...
var author$project$Ogham$fromString = A2(
	elm$core$Basics$composeR,
	...
	A2(
		...
		A2(
			elm$core$Basics$composeR,
			author$project$Ogham$parseChars(author$project$Ogham$default),
			A2(
				elm$core$Basics$composeR,
				elm$core$List$map(author$project$Ogham$toChar),
				elm$core$String$fromList))));
var author$project$Views$base03 = A3(mdgriffith$elm_ui$Element$rgb255, 116, 115, 105);
var author$project$Views$dateColor = author$project$Views$base03;
var author$project$Views$oghamColor = author$project$Views$base03;
var author$project$Views$flatMap = function (func) {
	return A2(
		elm$core$Basics$composeR,
		elm$core$List$map(func),
		A2(elm$core$List$foldr, elm$core$Basics$append, _List_Nil));
};
var author$project$Views$base02 = A3(mdgriffith$elm_ui$Element$rgb255, 81, 81, 81);
var author$project$Views$codeColor = author$project$Views$base02;
var author$project$Views$base01 = A3(mdgriffith$elm_ui$Element$rgb255, 57, 57, 57);
var author$project$Views$quoteColor = author$project$Views$base01;
...
var author$project$Views$renderInline = function (inline) {
	var recurseOver = author$project$Views$flatMap(author$project$Views$renderInline);
	switch (inline.$) {
		case 'Text':
			var string = inline.a;
			return _List_fromArray(
		...
		case 'Image':
			var source = inline.a;
			var title = inline.b;
			var roundBorder = mdgriffith$elm_ui$Element$el(
				_List_fromArray(
					[
						mdgriffith$elm_ui$Element$Border$rounded(
						author$project$Views$scaled(-4)),
						mdgriffith$elm_ui$Element$width(
						mdgriffith$elm_ui$Element$px(
							author$project$Views$scaled(12))),
			...
			var cover = A2(
				...
				_List_fromArray(
					[
						...
						mdgriffith$elm_ui$Element$Background$color(author$project$Views$backColor),
			...
			var img = A2(
				...
				_List_fromArray(
					[
						mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$fill),
						mdgriffith$elm_ui$Element$inFront(cover)
					]),
				{
			...
			var addPadding = mdgriffith$elm_ui$Element$el(
				_List_fromArray(
					[
						A2(
						mdgriffith$elm_ui$Element$paddingXY,
						0,
						author$project$Views$scaled(-1)),
		...
		case 'HtmlInline':
			var inlines = inline.c;
			return recurseOver(inlines);
		case 'Emphasis':
			var delim = inline.a;
			var inlines = inline.b;
			var attribs = (delim > 1) ? _List_fromArray(
				[mdgriffith$elm_ui$Element$Font$bold]) : ((delim === 1) ? _List_fromArray(
				[mdgriffith$elm_ui$Element$Font$italic]) : _List_Nil);
			return A2(
				elm$core$List$map,
				mdgriffith$elm_ui$Element$el(attribs),
				recurseOver(inlines));
		default:
			var kind = inline.a;
			var inlines = inline.b;
...
var author$project$Views$titleFont = mdgriffith$elm_ui$Element$Font$typeface('Roboto');
...
var author$project$Views$renderBlock = function (block) {
	var renderInlines = author$project$Views$flatMap(author$project$Views$renderInline);
	var recurseOver = author$project$Views$flatMap(author$project$Views$renderBlock);
	var blockSpacing = A2(
		mdgriffith$elm_ui$Element$spacingXY,
		author$project$Views$scaled(2),
		author$project$Views$scaled(-6));
	switch (block.$) {
		case 'BlankLine':
			return _List_Nil;
		case 'ThematicBreak':
		...
		case 'Heading':
			var level = block.b;
			var inlines = block.c;
			var size = (level >= 3) ? author$project$Views$scaled(2) : ((level === 2) ? author$project$Views$scaled(3) : author$project$Views$scaled(4));
			return _List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							...
							mdgriffith$elm_ui$Element$Font$family(
							_List_fromArray(
								[author$project$Views$titleFont])),
							mdgriffith$elm_ui$Element$paddingEach(
							{
								bottom: 0,
								left: 0,
								right: 0,
								top: author$project$Views$scaled(3)
							})
						]),
						...
						[
							...
							_List_fromArray(
								[
									...
									author$project$Views$scaled(-10)),
									mdgriffith$elm_ui$Element$Border$color(author$project$Views$codeColor),
									mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$shrink),
									mdgriffith$elm_ui$Element$alignLeft
								]),
							_List_fromArray(
						...
						[
							...
							_List_fromArray(
								[
									...
									author$project$Views$scaled(0),
									author$project$Views$scaled(-1)),
									mdgriffith$elm_ui$Element$Background$color(author$project$Views$quoteColor),
									mdgriffith$elm_ui$Element$Border$rounded(
									author$project$Views$scaled(0)),
									mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$shrink),
									mdgriffith$elm_ui$Element$alignLeft
		...
		case 'List':
					...
					return A2(
						...
						_List_fromArray(
							[
								...
								mdgriffith$elm_ui$Element$el,
								_List_Nil,
								mdgriffith$elm_ui$Element$text(bullet)),
								A2(
								mdgriffith$elm_ui$Element$paragraph,
								_List_Nil,
								recurseOver(item))
			...
			var endNum = startNum + elm$core$List$length(items);
			var bullets = A2(
				elm$core$List$map,
				function (n) {
					var _n1 = details.type_;
					if (_n1.$ === 'Unordered') {
						return '•';
					} else {
				...
				A2(elm$core$List$range, startNum, endNum));
			return _List_fromArray(
				[
					A2(
					mdgriffith$elm_ui$Element$column,
					...
					A3(elm$core$List$map2, entry, bullets, items))
				]);
		case 'PlainInlines':
			var inlines = block.a;
...
var author$project$Views$renderMd = function (markdown) {
	...
	return A2(
		...
		A2(
			author$project$Views$flatMap,
			author$project$Views$renderBlock,
			A2(pablohirafuji$elm_markdown$Markdown$Block$parse, config, markdown)));
};
var author$project$Views$base0A = A3(mdgriffith$elm_ui$Element$rgb255, 255, 204, 102);
var author$project$Views$titleColor = author$project$Views$base0A;
...
var author$project$Views$base0E = A3(mdgriffith$elm_ui$Element$rgb255, 204, 153, 204);
var author$project$Views$janderColor = author$project$Views$base0E;
var author$project$Views$base0D = A3(mdgriffith$elm_ui$Element$rgb255, 102, 153, 204);
var author$project$Views$landColor = author$project$Views$base0D;
...
var author$project$Views$topBar = function (model) {
	var coverFrag = author$project$Route$toFragment(author$project$Route$Cover);
	var coverLink = A2(
		mdgriffith$elm_ui$Element$link,
		_List_fromArray(
					...
					[
						...
						_List_fromArray(
							[
								...
								author$project$Views$scaled(3)),
								mdgriffith$elm_ui$Element$Font$color(author$project$Views$janderColor)
							]),
						mdgriffith$elm_ui$Element$text('jander')),
						A2(
						mdgriffith$elm_ui$Element$el,
						_List_fromArray(
							[
								mdgriffith$elm_ui$Element$Font$size(
								author$project$Views$scaled(2)),
								mdgriffith$elm_ui$Element$Font$color(author$project$Views$landColor)
							]),
						mdgriffith$elm_ui$Element$text('.land'))
					])),
			url: coverFrag
		});
	return A2(
...
var author$project$Views$chapterPage = F2(
	function (model, content) {
		var ogham = A2(
			...
			_List_fromArray(
				[
					mdgriffith$elm_ui$Element$Font$size(
					author$project$Views$scaled(2)),
					mdgriffith$elm_ui$Element$Font$color(author$project$Views$oghamColor)
				]),
			mdgriffith$elm_ui$Element$text(
				author$project$Ogham$fromString(content.name)));
		var name = A2(
			mdgriffith$elm_ui$Element$paragraph,
			_List_fromArray(
				[
					mdgriffith$elm_ui$Element$Font$size(
					author$project$Views$scaled(8)),
					mdgriffith$elm_ui$Element$Font$color(author$project$Views$titleColor),
					mdgriffith$elm_ui$Element$Font$family(
					_List_fromArray(
						[author$project$Views$titleFont])),
					mdgriffith$elm_ui$Element$Font$bold
			...
			_List_fromArray(
				[
					mdgriffith$elm_ui$Element$text(content.name)
				]));
		var formatDate = A2(
		...
		var date = A2(
			...
			_List_fromArray(
				[
					mdgriffith$elm_ui$Element$Font$size(
					author$project$Views$scaled(-1)),
					mdgriffith$elm_ui$Element$Font$color(author$project$Views$dateColor)
				]),
			mdgriffith$elm_ui$Element$text(
		...
		return _List_fromArray(
			[
				author$project$Views$topBar(model),
				header,
				author$project$Views$renderMd(content.body)
			]);
	});
...
var author$project$Views$chapterDate = function (content) {
	var year = A3(
		ryannhg$date_format$DateFormat$format,
		_List_fromArray(
			[ryannhg$date_format$DateFormat$yearNumber]),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				mdgriffith$elm_ui$Element$text(monthAndDay)),
				A2(
				mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[mdgriffith$elm_ui$Element$centerX]),
...
var author$project$Views$filterInline = function (inline) {
	var recurseOver = author$project$Views$flatMap(author$project$Views$filterInline);
	switch (inline.$) {
		case 'Text':
			var string = inline.a;
			return elm$core$String$toList(string);
		case 'CodeInline':
			var string = inline.a;
			return elm$core$String$toList(string);
		case 'Link':
...
var author$project$Views$filterBlock = function (block) {
	if (block.$ === 'Paragraph') {
		var inlines = block.b;
		return A2(author$project$Views$flatMap, author$project$Views$filterInline, inlines);
	} else {
		return _List_Nil;
	}
};
var author$project$Views$filterSpecials = function (markdown) {
	var config = elm$core$Maybe$Just(
		{rawHtml: pablohirafuji$elm_markdown$Markdown$Config$DontParse, softAsHardLineBreak: false});
	return elm$core$String$fromList(
		A2(
			author$project$Views$flatMap,
			author$project$Views$filterBlock,
			A2(pablohirafuji$elm_markdown$Markdown$Block$parse, config, markdown)));
};
var author$project$Views$chapterSummary = function (content) {
	var postFrag = author$project$Route$toFragment(
		author$project$Route$Chapter(content.id));
	var title = A2(
		mdgriffith$elm_ui$Element$link,
		_List_fromArray(
			[
		...
		{
			label: mdgriffith$elm_ui$Element$text(content.name),
			url: postFrag
		});
	var excerpt = A2(
		elm$core$String$join,
		...
		A2(
			...
			20,
			elm$core$String$words(
				author$project$Views$filterSpecials(content.body))));
	var summary = A2(
		mdgriffith$elm_ui$Element$paragraph,
		_List_Nil,
		_List_fromArray(
...
var author$project$Views$chapterList = F2(
	function (model, contents) {
		var summaries = A2(elm$core$List$map, author$project$Views$chapterSummary, contents);
		var space = function () {
			var _n0 = model.layout;
			if (_n0.$ === 'Mini') {
				return author$project$Views$scaled(2);
			} else {
				return author$project$Views$scaled(5);
			}
		}();
		var dates = A2(elm$core$List$map, author$project$Views$chapterDate, contents);
		var chapter = F2(
			function (date, summary) {
				return A2(
					mdgriffith$elm_ui$Element$row,
					_List_fromArray(
						[
		...
		return A2(
			mdgriffith$elm_ui$Element$column,
			_List_Nil,
			A3(elm$core$List$map2, chapter, dates, summaries));
	});
var author$project$Views$coverBar = function (model) {
	var ogham = A2(
		mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
		...
		mdgriffith$elm_ui$Element$text(
			author$project$Ogham$fromString('little known lots to learn')));
	var janderland = _List_fromArray(
		[
			A2(
			mdgriffith$elm_ui$Element$el,
			_List_fromArray(
	...
	var commonAttribs = _List_fromArray(
		[
			mdgriffith$elm_ui$Element$Font$bold,
			mdgriffith$elm_ui$Element$Font$family(
			_List_fromArray(
	...
	var title = function () {
		var _n0 = model.layout;
		if (_n0.$ === 'Full') {
			return A2(mdgriffith$elm_ui$Element$paragraph, commonAttribs, janderland);
		} else {
			return A2(mdgriffith$elm_ui$Element$column, commonAttribs, janderland);
		}
	}();
	return A2(
		mdgriffith$elm_ui$Element$column,
...
var author$project$Views$coverPage = function (model) {
	var chapters = A2(author$project$Views$chapterList, model, author$project$Contents$contentList);
	return _List_fromArray(
		[
			author$project$Views$coverBar(model),
			A2(
			mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[mdgriffith$elm_ui$Element$centerX]),
			A2(
				...
				_List_fromArray(
					[
						mdgriffith$elm_ui$Element$text('on its way…')
					]))),
			chapters
		]);
};
var author$project$Views$base05 = A3(mdgriffith$elm_ui$Element$rgb255, 211, 208, 200);
var author$project$Views$foreColor = author$project$Views$base05;
var author$project$Views$mainFont = mdgriffith$elm_ui$Element$Font$typeface('Merriweather');
var author$project$Views$notFoundPage = function (_n0) {
	var coverFrag = author$project$Route$toFragment(author$project$Route$Cover);
	return _List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					...
					{
						label: mdgriffith$elm_ui$Element$text('back to cover'),
						url: coverFrag
					})
				]))
		]);
};
var author$project$Views$root = function (model) {
	return A2(
		elm$core$Basics$composeL,
		mdgriffith$elm_ui$Element$el(
			_List_fromArray(
	...
	var _n0 = function () {
		...
		switch (_n1.$) {
			case 'Cover':
				return _Utils_Tuple2(
					'jander.land',
					author$project$Views$coverPage(model));
			case 'Chapter':
				var content = _n1.a;
				return _Utils_Tuple2(
					content.name,
					A2(author$project$Views$chapterPage, model, content));
			default:
				return _Utils_Tuple2(
					'not found',
					author$project$Views$notFoundPage(model));
		}
	}();
	var title = _n0.a;
	var children = _n0.b;
			...
			[
				...
				_List_fromArray(
					[
						...
						mdgriffith$elm_ui$Element$Font$family(
						_List_fromArray(
							[author$project$Views$mainFont])),
						mdgriffith$elm_ui$Element$Font$size(
						author$project$Views$scaled(1)),
						mdgriffith$elm_ui$Element$Font$color(author$project$Views$foreColor)
					]),
				A2(author$project$Views$root, model, children))
			]));
};
var elm$browser$Browser$application = _Browser_application;
var elm$json$Json$Decode$andThen = _Json_andThen;
var author$project$Janderland$main = elm$browser$Browser$application(
	{init: author$project$Janderland$init, onUrlChange: author$project$State$UrlChanged, onUrlRequest: author$project$State$LinkClicked, subscriptions: author$project$Janderland$subs, update: author$project$Janderland$update, view: author$project$Views$view});
_Platform_export({'Janderland':{'init':author$project$Janderland$main(
	A2(
